  ...
  return (
    <div className="grid gap-6">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-2 font-headline"><UploadCloud /> Sermon Pipeline</CardTitle>
                    <CardDescription>Manage your weekly sermon content from upload to publication.</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Sermons that have been transcribed and are ready for content generation and approval.</CardDescription>
                </CardHeader>
                <CardContent>
                     {sermonsToReview.length > 0 ? (
                        ...
                        <p className="text-sm text-muted-foreground">No sermons are currently ready for review.</p>
                    )}
                </CardContent>
            </Card>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Sermons that have been uploaded but not yet transcribed.</CardDescription>
                </CardHeader>
                <CardContent>
                    {drafts.length > 0 ? (
                        <ul className="space-y-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>An overview of the most recent sermons in your pipeline.</CardDescription>
        </CardHeader>
        <CardContent>
                            ...
                            <tr key={sermon.id} className="border-t">
                                ...
                                <td className="py-3 text-right">
                                    <Button asChild variant="ghost" size="sm">
                                        <Link href={`/dashboard/sermons/${sermon.id}`}>View <ArrowRight className="ml-2 h-4 w-4" /></Link>
                                    </Button>
                                </td>
                            </tr>
                        ))}
